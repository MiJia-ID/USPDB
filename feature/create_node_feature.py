...
def create_features(query_ids,all_702_path,train_path,test_path,pkl_path,esm2_5120_path,ProtTrans_path):
    '''
        load node features :
        1) Esm2-t48(5120dim),ProtTrans(1024dim),
        2) Residual_feats(PSSM-30dim,AF-7dim,DSSP-14dim)
        3) One-hot(20dim)
    '''
    ...
    for i in range(len(query_ids)):
        ...
        # node_features[query_ids[i]] = {'seq': i + 1, 'residue_fea': feature1[i], 'esm2_5120': feature3[i],
        #                                'esm2_33': feature5[i], 'prottrans_1024': feature4[i], 'msa_256': feature6[i],
        #                                'one-hot': feature2[i], 'label': protein_labels[i]}
        node_features[query_ids[i]] = {'seq': i + 1, 'residue_fea': feature1[i], 'esm2_5120': feature3[i],
                                       'prottrans_1024': feature4[i],'one-hot': feature2[i], 'label': protein_labels[i]}
...
def create_dataset(query_ids, train_path, test_path, all_702_path, pkl_path, esm2_5120_path,
                       ProtTrans_path, residue, one_hot, esm_5120, prottrans):
    '''
    ...
    node_features = create_features(query_ids,all_702_path,train_path,test_path,pkl_path,esm2_5120_path,ProtTrans_path)
    ...
    for i in query_ids:
        ...
        # if residue == True and one_hot == True and esm_5120 == True and prottrans == True and msa == True :   # all embeddings
        ...
        # protein language model embeddings
            ...
            features[i] = np.hstack((mat1, mat2, mat5))
        elif residue == True and one_hot == True and esm_5120 == True and prottrans == False:
            features[i] = np.hstack((mat1, mat2, mat4))
        elif residue == True and one_hot == True and esm_5120 == False and prottrans == False:
            features[i] = np.hstack((mat1, mat2))
        elif residue == True and one_hot == True and esm_5120 == False and prottrans == True:
            features[i] = np.hstack((mat1, mat2, mat5))
        elif residue == True and one_hot == True and esm_5120 == True and prottrans == True:
            features[i] = np.hstack((mat1, mat2, mat4, mat5))
        elif residue == False and one_hot == False and esm_5120 == False and prottrans == True:  # only protein language model embeddings
            features[i] = np.hstack((mat5))
        elif residue == False and one_hot == False and esm_5120 == True and prottrans == False:  # only protein language model embeddings
            features[i] = np.hstack((mat4))
